...
> 前端页面可以直接内嵌在 `worker.js` 中，也可以独立部署在 Cloudflare Pages。
...
> 如果使用 Cloudflare Pages 也可以通过 Pages 的环境变量功能设置。
...
1. **Fork 本项目** 或者 **新建 Worker / Pages 项目**
2. **复制 `worker.js` 内容** 到你的 Worker 或 Pages 项目中
3. **在环境变量中设置** `API`、`TOKEN`、`DOMAIN`
4. 打开 Worker / Pages 地址即可访问
